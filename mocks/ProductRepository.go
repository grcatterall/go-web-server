...
func (_m *MockProductRepository) DeleteProduct(id string) (bool, error) {
	ret := _m.Called(id)
...
func (_m *MockProductRepository) GetProductById(id string) (models.Product, error) {
	ret := _m.Called(id)
...
func (_m *MockProductRepository) GetProductByName(name string) (models.Product, error) {
	ret := _m.Called(name)
...
func (_m *MockProductRepository) UpdateProduct(id string, product models.Product) (models.Product, error) {
